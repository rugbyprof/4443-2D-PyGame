...
Description:
    ...
    Classes: 
        ...
        HitBox:
            This class creates a "hitbox" that is a pygame.sprite attached to the "player" and has sides that can
            be adjusted so that collisions with objects can be tailored. I haven't tested it with bullets or anything
            but platforms. 

            You can create a hitbox by passing in a rectangle (x,y,w,h) or all four of the params seperately.
