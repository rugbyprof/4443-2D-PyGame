...
Description:
   ...
   Moves a "player" (shape) around on a tiled background.
...
def main():
    ...
    while running:
        ...
        # Add tiled background to window (will change later)
        for i in range(0,config['window_size']['width'],bgimg_size[0]):
            for j in range(0,config['window_size']['height'],bgimg_size[1]):
                screen.blit(bgimg,(i,j))
