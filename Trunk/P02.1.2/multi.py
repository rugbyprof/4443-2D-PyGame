...
config = {
    ...
    'tiles_path':'./resources/maps/forest_clean/',
    'tile_size':20,
    'debug': True,
    'debug_level':20
    }
...
class StateMananger(Borg):
    def __init__(self):
        ...
        self.states = [
            GameMenu(),
            LevelLoader(levels_path="./resources/levels",tiles_path="./resources/maps/forest_clean/Tiles_20",level_name="level_01",tile_size=(20,20)),
            LevelLoader(levels_path="./resources/levels",tiles_path="./resources/maps/forest_clean/Tiles_20",level_name="level_02",tile_size=(20,20)),
            LevelLoader(levels_path="./resources/levels",tiles_path="./resources/maps/forest_clean/Tiles_20",level_name="level_03",tile_size=(20,20))
        ]
        self.go_to()
